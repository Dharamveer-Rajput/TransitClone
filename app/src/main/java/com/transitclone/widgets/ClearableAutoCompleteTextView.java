...
/**
 * Created by Aman Rai on 01/17/18.
 */
 ...
 */
public class ClearableAutoCompleteTextView extends android.support.v7.widget.AppCompatAutoCompleteTextView implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    private void init(final Context context) {
        ...
        DrawableCompat.setTint(wrappedDrawable, ContextCompat.getColor(context, R.color.colorAccent));
